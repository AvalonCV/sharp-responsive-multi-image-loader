...
const loader = function (content) {
    ...
    const { name_prefix = '[name]', target_formats = ['jpeg', 'webp'], widths = [1280, 640], emitFile = true } = options;
    ...
    if (typeof content === 'string') {
        ...
        image
            ...
            if (!metadata.format || metadata.format === 'svg') {
                ...
                callback &&
                    callback(null, imageToString(Object.assign(Object.assign({}, source_dimensions), { src, type: metadata.format || 'undefined' })));
            }
            else {
                ...
                Promise.all(promises).then(image_targets => {
                    ...
                    callback &&
                        callback(null, imageToString(Object.assign(Object.assign({}, source_dimensions), { src: default_image_source, type: 'jpeg', placeholder: placeholder_data_uri, responsive_images: image_targets
